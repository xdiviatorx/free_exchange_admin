...
public class ApprovedOffersFragment extends Fragment implements AbsListView.OnScrollListener, SwipeRefreshLayout.OnRefreshListener, OnDownloadListener{
    ...
    public ApprovedOffersFragment(){}

    @Override
    public void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        receiver = new ApprovedReceiver();
        IntentFilter filter = new IntentFilter(APPROVE_ACTION);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_approved_offers,container,false);
    }
    ...
    private void initViews(View view){
        ...
        offersAdapter.init(RestClient.APPROVED_STATUS);
    ...
    class ApprovedReceiver extends BroadcastReceiver{
